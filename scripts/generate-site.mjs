...
function faq(page) {
  ...
  return `
    <section class="section-padding" id="faq" style="background: var(--bg-surface-alt); border-top: 1px solid var(--border-light);">
      <div class="container">
        <div class="section-head">
...
<html lang="${page.lang}">
  <head>
    ...
    })(window,document,'script','dataLayer','GTM-WMBGFSF3');</script>
  ...
  <body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WMBGFSF3"
    ...
    <!-- Mobile Bottom CRO Bar (WhatsApp Green Button) -->
    ...
    <!-- Floating WhatsApp Green Button Desktop -->
